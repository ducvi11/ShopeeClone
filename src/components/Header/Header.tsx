      ...
      <div className='container'>
            ...
            <Popover
              ...
              renderPopover={
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                  <Link
                    to={path.profile}
                    className='w-full text-left block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500'
                  >
                    Tài khoản của tôi
                  </Link>
                  <Link
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          <Link to='/' className='col-span-2'>
            <svg viewBox='0 0 192 65' className='h-8 w-full lg:h-11 fill-white'>
              <g fillRule='evenodd'>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/065c9c35c4bac096c8d38a56c602849b_tn'
                            alt='anh'
                            className='w-11 h-11 object-cover'
                          />
                        </div>
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='trumcate'>
                            Sách - Từ tốt đến vĩ đại, xây dựng để trường tồn, vĩ đại do
                            bạn lựa chon( lẻ tuỳ chọn)
                          </div>
                        </div>
